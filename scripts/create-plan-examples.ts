...
const [sixEn, sixRu, twelveEn, twelveRu] = await Promise.all([
...
if ([sixEn, sixRu, twelveEn, twelveRu].some((pages) => pages.length !== 1)) {
...
console.log('Saved 6- and 12-month roadmap examples in English and Russian.');
